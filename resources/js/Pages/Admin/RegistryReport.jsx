...
export default function RegistryReport({ submissions, summary, filters, currentFilters }) {
    ...
    const handleExport = () => {
        ...
        window.open(`/admin/registry/report/export?${params.toString()}`, '_blank');
    };
                        ...
                        <div className="flex justify-between items-center">
                            <div>
                                <h1 className="text-3xl font-bold text-gray-900">
                                    Registry Document Upload Report
                                </h1>
                                <p className="mt-2 text-gray-600">
                                    Track and monitor student document uploads for registry
                                </p>
                            </div>
                    ...
                    <div className="bg-white shadow overflow-hidden sm:rounded-md">
                        <div className="px-4 py-5 sm:px-6">
                            ...
                            <p className="mt-1 max-w-2xl text-sm text-gray-500">
                                Document upload status for registry students
                            </p>
                        </div>
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <p className="text-sm text-gray-500">
                                                    {submission.academic_year} • {submission.semester}
                                                </p>
                                            </div>
