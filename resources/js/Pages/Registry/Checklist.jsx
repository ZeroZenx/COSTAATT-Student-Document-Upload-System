...
import { ClipboardDocumentListIcon, CheckCircleIcon, ExclamationTriangleIcon } from '@heroicons/react/24/outline';
...
export default function Checklist({ submission }) {
    ...
    const handleFinalizeSubmission = async () => {
        ...
        try {
            ...
            if (response.ok) {
                alert(`✅ Registry submission finalized successfully!\n\nReference Number: ${data.reference || 'N/A'}\n\nCheck your email for confirmation.`);
